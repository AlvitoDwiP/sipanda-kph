...
class DisplayJobdeskController extends Controller
{
    public function manage()
    {
        ...
        return view('pages.display.manage', [
            ...
            'tvRoute' => route('admin.display-jobdesk.tv'),
            'stateRoute' => route('admin.display-jobdesk.state'),
            'settingUpdateRoute' => route('admin.display-jobdesk.settings.update'),
            'resetRoute' => route('admin.display-jobdesk.reset'),
            'setting' => $setting,
            'logs' => $logs,
            'summary' => $summary,
        ]);
    ...
    public function tv()
    {
        ...
        return view('pages.display.jobdesk', [
            ...
            'stateRoute' => route('admin.display-jobdesk.state'),
            'backRoute' => route('admin.display-jobdesk.manage'),
            'pageTitle' => 'Display Job Desk Harian',
    ...
    {
        return redirect()->route('admin.display-jobdesk.manage');
    }
