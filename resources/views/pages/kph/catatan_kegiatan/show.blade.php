...
<div class="bg-white rounded-xl shadow-sm border border-slate-100 mb-6">
    <div class="p-6 border-b border-slate-100 flex justify-between">
        ...
        <a href="{{ route('kph.catatan_kegiatan.index') }}" class="text-sm text-slate-500">Kembali</a>
    </div>
    ...
    <div class="p-6 space-y-3 text-sm">
        ...
        @if($catatan->status_verifikasi === 'menunggu_verifikasi')
            <div class="pt-4 border-t space-y-3">
                ...
                <form method="POST" action="{{ route('kph.catatan_kegiatan.revisi', $catatan->id) }}" class="space-y-2">
                    @csrf
                ...
                <form method="POST" action="{{ route('kph.catatan_kegiatan.tolak', $catatan->id) }}" class="space-y-2">
                    @csrf
