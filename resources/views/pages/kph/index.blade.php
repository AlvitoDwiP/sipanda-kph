...
<div class="grid gap-6 lg:grid-cols-3 items-stretch select-none">
    ...
    <div class="bg-ui-surface rounded-ui-xl border border-ui-border p-5 shadow-ui-sm flex flex-col justify-between">
        <div class="border-b border-ui-border pb-2.5 mb-3">
            ...
            <p class="text-[10px] text-ui-text-secondary mt-0.5">Saring data penugasan berdasarkan tanggal dan unit kerja</p>
        </div>
...
<div>
    <x-ui.section-header title="Statistik Penugasan Pegawai" description="Ringkasan tugas per tanggal {{ \Carbon\Carbon::parse($tanggalFilter)->format('d-m-Y') }} untuk wilayah KPH." />
...
<div>
    <x-ui.section-header title="Statistik Catatan Kegiatan" description="Status laporan aktivitas harian pegawai." />
