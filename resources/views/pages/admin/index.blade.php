...
<div class="mb-4">
    <x-ui.section-header title="Statistik Catatan Kegiatan" description="Status pengajuan laporan aktivitas harian pegawai." class="mb-2" />
            ...
            <x-ui.table :headers="['Tugas', 'Pegawai', 'Unit Kerja', 'Aksi']" :empty="$tugasTerlambat->isEmpty()">
                <x-slot name="emptyState">
                    <x-ui.empty-state 
                        ...
                        description="Hebat! Tidak ada penugasan kerja yang melewati batas waktu saat ini." 
                    >
                        <x-slot name="primaryAction">
            ...
            <x-ui.table :headers="['Pegawai', 'Pekerjaan', 'Tanggal Laporan', 'Aksi']" :empty="$catatanMenungguVerifikasi->isEmpty()">
                <x-slot name="emptyState">
                    <x-ui.empty-state 
                        ...
                        description="Tidak ada pengajuan laporan kegiatan pegawai yang menunggu persetujuan Anda." 
                    >
                        <x-slot name="primaryAction">
