        ...
        <table class="w-full text-sm">
            ...
            <tbody class="divide-y divide-slate-100">
                ...
                <tr>
                    ...
                    <td class="py-3 text-right"><a href="{{ route('admin.catatan_kegiatan.show', $item->id) }}" class="text-blue-700">Detail</a></td>
                </tr>
                @empty
                <tr><td colspan="5" class="py-8 text-center text-slate-400">Belum ada data catatan kegiatan</td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
